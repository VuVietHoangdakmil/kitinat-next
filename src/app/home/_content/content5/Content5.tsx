  ...
  return (
    <>
      ...
      <ExitAnimation
        ...
        slideSize={reponsive?.isMobile ? "100%" : "100%/3"}
        slides={SLIDES}
        options={{
          ...OPTIONS,
        }}
